 ...
 */
public class RawReponseTextConverter {
    /**
     * Convert raw String with hex codes to decoded string
     *
     * @param text Raw "\\uXXXX\\uXXXX" text recieved from gateway
    ...
    public String convert(String text) {
        try {
            ...
            throw new IllegalStateException("Text '" + text + "' contains UTF-16 codes, but UTF-8 encoding is not supported", ex);
        }
    }

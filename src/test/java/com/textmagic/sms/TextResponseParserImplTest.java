...
public class TextResponseParserImplTest {
    ...
    public void testParseMessageStatusResponse() throws Exception {
        ...
        assertEquals(new Date(1242937000L), firstResult.getCreatedTime());
        ...
        assertEquals(new Date(1234567), secondResult.getCreatedTime());
        assertEquals(new Date(111111), secondResult.getCompletedTime());
    ...
    public void testParseRecieveResponse() throws Exception {
        ...
        assertEquals(new Date(1242939052), firstResult.getReceivedDate());
        ...
        assertEquals(new Date(1242939235), secondResult.getReceivedDate());
    }
